$("document").ready(function(){
    ...
    $(".smallImgs2").mouseover(function(){
        var smallIMG = document.getElementsByClassName("smallImgs2")
        var activeIMG = document.getElementsByClassName("Imgactive2")
        for(var i=0; i<smallIMG.length;i++){
            smallIMG[i].addEventListener("mouseleave",function(){
                if(activeIMG.length>0){
                    $(".Imgactive2").css("width","50px")
                    $(".Imgactive2").css("height","50px")
                    activeIMG[0].classList.remove("Imgactive2")
        ...
        $(".Imgactive2").css("width","60px")
        $(".Imgactive2").css("height","60px")
